...
def post_process_output(q_img, cos_img, sin_img, width_img, length_img):
    """
    ...
    width_img = width_img.cpu().numpy().squeeze() * 112.0
    length_img = length_img.cpu().numpy().squeeze() * 112.0
